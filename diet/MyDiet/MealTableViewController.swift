...
//        if(actualhour >  self.allMeals[indexPath.row].hour + 1 && isNew == false){
//            cell.isUserInteractionEnabled = false
//            cell.backgroundColor = UIColor.lightGray
//        }
//        else if(actualhour == self.allMeals[indexPath.row].hour && isNew == false){
//            if(actualminute > self.allMeals[indexPath.row].minute + 30){
//                cell.isUserInteractionEnabled = false
//                cell.backgroundColor = UIColor.lightGray
//            }
//        }
