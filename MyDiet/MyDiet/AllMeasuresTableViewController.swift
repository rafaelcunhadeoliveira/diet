...
class AllMeasuresTableViewController: UITableViewController {
    ...
    var reverseAllMeasures: Array<Measure> = []
    var year: Int = 0
    var month: Int = 0
    var day: Int = 0
    var chest: Float = 0
    ...
    override func viewDidLoad() {
        ...
        do{
            ...
            if resultsMeasure.count > 0{
                for resultM in resultsMeasure as! [NSManagedObject]{
                    ...
                    self.reverseAllMeasures.append(actualMeasure)
        ...
        self.allMeasures = reverseAllMeasures.reversed()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let destination = segue.destination as? IndividualMeasureViewController{
